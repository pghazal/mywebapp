...
@script = <<SCRIPT
DOCUMENT_ROOT_ZEND="/var/www/mywebapp/public"
apt-get update
...
" > /etc/apache2/sites-available/mywebapp.conf
a2enmod rewrite
...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.hostname = "mywebapp.local"
  config.vm.synced_folder '.', '/var/www/mywebapp'
